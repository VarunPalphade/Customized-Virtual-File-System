...
void DisplayHelp()   //line 130
{
    ...
    printf("fstat : To Display information of file using file descrition \n");
    printf("truncate : To Remove all data from file \n");
    printf("rm : To Delete the file \n");
}

int GetFDFromName(char *name)  //line 146
{
    int i = 0;
...
PINODE Get_Inode(char *name)     //line 162
{
    PINODE temp = head;
    int i = 0;
...
int InitialiseSuperBlock()   //line 214
{
    int i = 0;
    while (i < MAXINODE)
    {
...
int CreateFile(char *name, int permission)  //line 227
{
    int i = 0;
    PINODE temp = head;
...
//   rm_File("demo.txt")
int rm_File(char *name)   //line 279
{
    int fd = 0;
...
int ReadFile(int fd , char *arr , int isize)    //line 300
{
    int read_size = 0;
...
int WriteFile(int fd , char *arr , int isize)  //line 331
{
...
int OpenFile(char *name , int mode)   //line 350
{
    int i = 0;
    PINODE temp = NULL;
...
void CloseFileByName(int fd)  //line 395
{
...
int CloseFileByName(char *name)   //line 402
{
    int i = 0;
...
int LseekFile(int fd , int size , int from)      //line 432
{
...
int fstat_file(int fd)   //line 509
{
    PINODE temp = head;
    int i = 0;
...
int stat_file(char *name)  //line 539
{
    PINODE temp = head;
    int i = 0;
...
int truncate_File(char *name)   //line 574
{
    ...
    while(1)     //shell
    {
        ...
        else if(count == 3)     //714
        {
            if(strcmp(command[0],"create") == 0)
            {
                ...
                if(ret == -4)
                    printf("ERROR : Memory aloocation failure \n");
                continue;
            }
